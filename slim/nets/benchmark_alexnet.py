...
def inference(images):
    ...
    conv2 = _conv (pool1,  64, 192, 5, 5, 1, 1, 'SAME',args.groups)
    pool2 = _mpool(conv2,  3, 3, 2, 2)
    conv3 = _conv (pool2,  192, 384, 3, 3, 1, 1, 'SAME')
    conv4 = _conv (conv3,  384, 256, 3, 3, 1, 1, 'SAME',args.groups)
    conv5 = _conv (conv4,  256, 256, 3, 3, 1, 1, 'SAME',args.groups)
...
def main(_):
  ...
  print('Running on CPU :', args.cpu, 'with groups:', args.groups)
  run_benchmark()
